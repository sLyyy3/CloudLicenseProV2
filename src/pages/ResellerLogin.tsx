// src/pages/ResellerLogin.tsx - RESELLER LOGIN
  ...
  async function handleLogin() {
    ...
    try {
      ...
      openDialog({
        ...
        message: "Du wirst zu deinem Reseller Dashboard weitergeleitet...",
        closeButton: "OK",
      });
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-4">
          <div className="bg-[#1A1A1F] border border-[#2C2C34] rounded-lg p-8 w-full max-w-md shadow-xl">
            ...
            <div className="mb-8 text-center">
              ...
              <h2 className="text-3xl font-bold">🏪 Reseller Login</h2>
            ...
            <div className="space-y-2 text-sm text-center">
              <p className="text-gray-500">Andere Optionen:</p>
              <button
                onClick={() => navigate("/dev-register")}
                className="block w-full text-gray-400 hover:text-purple-400 transition"
              >
                👨‍💻 Als Developer registrieren
              </button>
              <button
                onClick={() => navigate("/login")}
                className="block w-full text-gray-400 hover:text-green-400 transition"
              >
                👤 Normale Anmeldung
              </button>
            </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl">
            <div className="bg-[#1A1A1F] border border-[#2C2C34] rounded-lg p-6 text-center">
              ...
              <h3 className="font-bold mb-2">Dein Shop</h3>
              <p className="text-xs text-gray-400">
                Verkaufe Keys von verschiedenen Entwicklern
              </p>
            </div>
            ...
            <div className="bg-[#1A1A1F] border border-[#2C2C34] rounded-lg p-6 text-center">
              ...
              <p className="text-xs text-gray-400">
                Sehe deine Verkaufe und Einnahmen
              </p>
            </div>

            <div className="bg-[#1A1A1F] border border-[#2C2C34] rounded-lg p-6 text-center">
              <p className="text-3xl mb-2">💰</p>
              <h3 className="font-bold mb-2">Verdiene</h3>
              <p className="text-xs text-gray-400">
                Mit jedem verkauften Key verdienst du
              </p>
            </div>
          </div>
        </div>
